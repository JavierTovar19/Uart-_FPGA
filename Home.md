...
# Diseño Digital para FPGAs, con herramientas libres [\[English Version\]](//github.com/Obijuan/open-fpga-verilog-tutorial/wiki/Home_EN)
...
* **2016/12/29**: Clifford añade [un ejemplo hola mundo para la Icezum Alhambra](https://github.com/cliffordwolf/icestorm/tree/master/examples/icezum) dentro del proyecto Icestorm
...
* **2016/05/30**: El **esquemático** de la Icezum Alhambra se ha **migrado a [Kicad](http://kicad.org/)**, una herramienta libre de diseño electrónico ([repo](https://github.com/FPGAwars/icezum/tree/master/src-kicad))
